...
const Weather = () => {
    ...
    const allIcons = {
        ...
        "10n": rain_icon,
        "13d": snow_icon,
        "13n": snow_icon, // Corrected icon for night snow
    };
    ...
    const search = async (city) => {
        ...
        try {
            ...
            const response = await axios.get(url); // Changed to GET request
            ...
            //     return;
            //    }
                const icon = allIcons[data.weather[0].icon] || clear_icon; // Get appropriate icon
